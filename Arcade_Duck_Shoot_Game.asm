...
instruction0 db "[ INSTRUCTIONS ]$"
instruction1 db "[ Press '0' to EXIT ]$"
instruction2 db "1: Use mouse to move the gun and kill the duck.$"
instruction3 db "2: Killing each duck will result in addition of 1 point.$"
instruction4 db "3: Killing most of the ducks in each level will move$"
instruction44 db "you to the next level.$"
instruction5 db "4: There will be a total of 3 bullets to kill each duck.$"
instruction6 db "5: There will be a total of 3 levels in the game.$"
instruction7 db "6: Once you lose all lives, the game will be over.$"
menu0 db "[ MENU ]$"
menu1 db "1: PLAY GAME$"
menu2 db "2: INSTRUCTIONS$"
menu3 db "3: EXIT$"
inp db "PLEASE ENTER NAME : $"
var1 db 100 DUP('$')
loadbar db "Loading...$"
xcoor dw 0
ycoor dw 0
...
TEXT_TO_DISPLAY_THE_SCORE_AT_END_OF_THE_GAME db 'YOUR SCORE IS 3$'
THE_PLAYER_NUMBER_OF_PLAYER_WHO_WON_THE_GAME db 0
TEXT_MESSAGE_TO_ASK_USER_TO_PLAY_AGAIN db 'Press R To Play Again.', '$'
TEXT_MESSAGE_TO_ASK_USER_TO_GO_TO_THE_MAIN_MENU db 'Go to Menu (press E)', '$'
TEXT_TO_DISPLAY_TITLE_OF_THE_MAIN_MENU db 'MAIN PAGE', '$'
TEXT_MESSAGE_TO_SHOW_SINGLE_PLAYER db 'Press S For SINGLE PLAYER Mode','$'
TEXT_MESSAGE_TO_SHOW_EXIT_GAME db 'If you wish to Exit Game(Press E)', '$'
...
jnz LEFT_MOUSE_BUTTON_HAS_BEEN_PRESSED
jz SKIP_CHECKING
...
xor ax ,ax
mov al, THE_NUMBER_OF_BULLETS_REMAINING_FOR_PLAYER
cmp al , 00h
je GAME_OVER_FUNCTIONALITY1
...
mov al, NUMBER_OF_ROUNDS_IN_THE_GAME
add al ,30h
...
mov ah ,09h
lea dx ,TEXT_TO_DISPLAY_NUMBER_OF_BULLETS_LEFT
int 21h
...
mov ah ,09h
lea dx ,TEXT_MESSAGE_TO_DISPLAY_NUMBER_OF_ROUNDS
int 21h
...
mov ah, 09h
lea dx, TEXT_TO_DISPLAY_TITLE_OF_GAME_OVER_MENU
int 21h
...
mov ah, 09h
lea dx, TEXT_TO_DISPLAY_THE_SCORE_AT_END_OF_THE_GAME
int 21h
...
mov ah, 09h
lea dx, TEXT_MESSAGE_TO_ASK_USER_TO_PLAY_AGAIN
int 21h
